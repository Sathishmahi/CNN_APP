...
class DataIngestion:
    ...
    def download_data(self):
        ...
        if os.path.exists(path=local_data_file):
            ...
            logger.info(f' file already exist - file size is  {get_size(Path(local_data_file))}')
    ...
    def extract_data(self):
        ...
        with zip(local_data_file) as zf:
            ...
            all_filters_name=[name for name in all_content_name_list if name.endswith('.jpg') and ('Dog' in name or 'Cat' in name)]
